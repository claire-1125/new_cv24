...
public class PopUpSetting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pop_up_setting);

        button = findViewById(R.id.button);
        button.setOnClickListener(V -> {
            Toast.makeText(this, "pop up setting",Toast.LENGTH_SHORT).show();
    ...
    private void OpenPopUp(CharSequence message){
        Intent intent = new Intent(PopUpSetting.this, alertDanger.class);
